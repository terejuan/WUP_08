...
in conclusion as we make our predictions trought all these variables we can se that LENGTH ~ HEADLEN was one of best results we, it gaves us the smalest Residual standard error and the biggest Adjusted R-squared, fallowed by LENGTH ~ CHEST, LENGTH ~ NECK, then LENGTH ~ WEIGHT, fallowed by two of the worst predictions we got which are  LENGTH ~ HEADWTH  fallowed by LENGTH ~ AGE. These are the two worst because they gave us the smallest Adjusted R-squared numbers and the biggest Residual standard error.